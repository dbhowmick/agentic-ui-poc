...
config :agentic_ui, :vite_dev_server,
  enabled: true,
  port: 4001,
  allowed_hosts: []
...
config :agentic_ui, AgenticUiWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/agentic_ui_web/(?:controllers|live|components|router)/?.*\.(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :agentic_ui, dev_routes: true
