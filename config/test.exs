...
config :agentic_ui, AgenticUi.Repo,
  ...
  password: "postgres",
  hostname: "localhost",
  database: "agentic_ui_test#{System.get_env("MIX_TEST_PARTITION")}",
...
config :agentic_ui, AgenticUi.Mailer, adapter: Swoosh.Adapters.Test
...
config :agentic_ui, Oban, testing: :inline
